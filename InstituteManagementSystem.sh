...
# Project Title : "Institute Management System" 

# Student Names & Roll Numbers:  
# 1. 22K-8732 Mudasir
# 2. 22K-8714 Aman Ullah Kazi
# 3. 22K-4083 Arooba Faisal
# 2. 22K-4042 Syed Areeb Hussain    

# Section: BAI-4A
# Course: OS Theory
# Instructor: Miss Saeeda Kanwal           
                                 
echo -e "\nProject Title : \"Institute Management System\"\n\nStudent Names & Roll Numbers:  \n 1. 22K-8732 Mudasir\n 2. 22K-8714 Aman Ullah Kazi\n 3. 22K-4083 Arooba Faisal\n 4. 22K-4042 Syed Areeb Hussain    \n\nSection: BAI-4A\nCourse: OS Theory\nInstructor: Miss Saeeda Kanwal"


function head_banner() {
    echo -e ""
    echo -e "	\e[1mWELCOME TO INSTITUTE MANAGEMENT SYSTEM (OS PROJECT)\e[0m	"
    echo -e ""
}
